...
from skill_risk_manager.backend.models import CancelToken, ScanConfig, ScanEvent, ScanSummary, ScanTarget, SkillRecord
    ...
    def _scan_file(
        ...
        if stat_matches_cache(path, cache_record):
            ...
            if raw_cached_classification:
                record = cached_record_with_risk(raw_cached_classification, self.risk_policy)
